...
class GrainsReport extends Component implements HasActions, HasSchemas, HasTable
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->query(fn (): Builder => GrainAmort::query())
            ->columns([
                ...
                TextColumn::make('status')
                    ...
                    ->icons([
                        ...
                        'heroicon-s-x-circle' => 'overdue',
                        'heroicon-s-check-badge' => 'paid',
                        'heroicon-s-truck' => 'completed',
                    ])
    ...
    {
        return view('livewire.grains-report');
    }
}
