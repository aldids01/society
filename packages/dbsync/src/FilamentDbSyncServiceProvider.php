...
class FilamentDbSyncServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        // php artisan vendor:publish --provider="Aldids\FilamentDbSync\FilamentDbSyncServiceProvider" --tag="config"
        // php artisan vendor:publish --provider="Aldids\FilamentDbSync\FilamentDbSyncServiceProvider" --tag="migrations"
        // or
        // php artisan vendor:publish --provider="Aldids\FilamentDbSync\FilamentDbSyncServiceProvider"
