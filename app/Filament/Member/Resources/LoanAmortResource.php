...
use App\Filament\Member\Resources\LoanAmortResource\Pages;
use App\Filament\Member\Resources\LoanAmortResource\RelationManagers;
...
class LoanAmortResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pending Loan';
    protected static ?string $navigationGroup = 'Report';
    public static function getModelLabel(): string
    {
        return Auth::user()->name . ' Pending Loan';
    }
