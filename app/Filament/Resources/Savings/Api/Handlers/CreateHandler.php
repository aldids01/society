...
use App\Filament\Resources\Savings\Api\Requests\CreateSavingRequest;

class CreateHandler extends Handlers {
    public static string | null $uri = '/';
    public static string | null $resource = SavingResource::class;
    protected static string $permission = 'Create:Saving';
     ...
     */
    public function handler(CreateSavingRequest $request)
    {
